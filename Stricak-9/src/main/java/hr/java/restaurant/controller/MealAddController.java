...
public class MealAddController implements AddController {
    ...
    public void add() {
        ...
        if (!error.isEmpty()) {
            AlertDialog.showErrorDialog("Meal save error", error);
            logger.error("Meal save error: {}", error);
            return;
        }
        ...
        AlertDialog.showInformationDialog("Meal save", "Meal added successfully.");
